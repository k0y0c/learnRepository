...
/*
    ...
    那么这个流对象的作用域就在try中有效
    try中的代码执行完毕，会自动把流对象释放，不在写finally
    格式：
        try(定义流对象;定义流对象...){
            可能会产生异常的代码
        }catch(异常类变量 变量名){
...
public class Demo02JDK7 {
    public static void main(String[] args) {
        try(//1.创建一个字节输入流对象，构造方法中绑定要读取的数据源
            ...
            FileOutputStream fos = new FileOutputStream("E:\\mycode\\base-code\\base-second\\src\\com\\itheima\\IOAndProperties\\demo06\\trycatch\\1.jpg");){
            //一次读取一个字节写入一个字节的方式
