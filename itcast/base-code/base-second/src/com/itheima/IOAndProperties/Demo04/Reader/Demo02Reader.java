...
/*
    ...
    构造方法：
        ...
        FileReader(String fileName) ： 创建一个新的 FileReader ，给定要读取的文件
        参数：读取文件的数据源
...
public class Demo02Reader {
    public static void main(String[] args) throws IOException {
        //1.创建FileReader对象，构造方法中绑定要读取的数据源
        FileReader fr = new FileReader("E:\\mycode\\base-code\\base-second\\src\\com\\itheima\\IOAndProperties\\c.txt");
        //2.使用FileReader对象中的方法read读取文件
        //public int read() ： 从输入流读取一个字符。
        /*int len = 0;
        while((len = fr.read())!=-1){
