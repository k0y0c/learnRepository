...
public class Demo01CopyFile {
    public static void main(String[] args) throws IOException {
        ...
        //1.创建一个字节输入流对象，构造方法中绑定要读取的数据源
        FileInputStream fis = new FileInputStream("E:\\mycode\\base-code\\base-second\\src\\com\\itheima\\IO\\1.jpg");
        //2.创建一个字节输出流对象，构造方法中绑定要写入的目的地
        FileOutputStream fos = new FileOutputStream("E:\\mycode\\base-code\\base-second\\src\\com\\itheima\\IO\\demo02\\CopyFile\\1.jpg");
