...
/*
    java.util.List接口 extends Colllection接口
    List接口的特点：
...
public class Demo01List {
    public static void main(String[] args) {
        ...
        System.out.println("被移除的元素：" + s);      //被移除的元素：c
        System.out.println(list);               //[a, b, itheima, d, a]

        //public E set(int index, E element) :用指定元素替换集合中指定位置的元素,返回值的更新前的元素。
        //把最后一个a替换为A
        String s1 = list.set(4, "A");
        System.out.println("被替换的元素：" + s1);     //被替换的元素：a
        System.out.println(list);                       //[a, b, itheima, d, A]
        ...
        //String r = list.get(5);
        //System.out.println(r);      //IndexOutOfBoundsException 索引越界异常
    }
}
