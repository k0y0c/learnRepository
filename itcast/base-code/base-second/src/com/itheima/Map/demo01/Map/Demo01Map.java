...
/*
    ...
    java.util.HashMap<k,v>集合 implments Map<k,v>接口
    HashMap集合的特点：
        1.HashMap集合底层是哈希表：查询的速度特地的快
            JDK1.8之前：数组+单向链表
...
public class Demo01Map {
    ...
    */
    ...
    private static void show02() {
        ...
        Integer v2 = map.remove("林志颖");         //用int接收，会报NullPointerException，null不能赋值给int类型
        //int v2 = map.remove("林志颖");         //用int接收，会报NullPointerException，null不能赋值给int类型
